...
//ROZKAZY
	  ...
	  const int RobotProcessor::RAND = 12;
	  const int RobotProcessor::STORE = 13;
	  const int RobotProcessor::LOAD = 14;
	  const int RobotProcessor::READ = 15;
	  const int RobotProcessor::INC = 16;
	  const int RobotProcessor::DEC = 17;
	  const int RobotProcessor::JUMP = 18;
	  const int RobotProcessor::JEQUAL = 19;
	  const int RobotProcessor::JNEQUAL = 20;
	  const int RobotProcessor::JGT = 21;
	  const int RobotProcessor::JLT = 22;
	  const int RobotProcessor::JUMPF = 23;
	  const int RobotProcessor::JEQUALF = 24;
	  const int RobotProcessor::JNEQUALF = 25;
	  const int RobotProcessor::JGTF = 26;
	  const int RobotProcessor::JLTF = 27;
	  const int	RobotProcessor::RETURN = 28;
